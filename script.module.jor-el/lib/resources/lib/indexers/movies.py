...
class movies:
    def __init__(self):
        ...
        self.added_link = (
            "http://www.imdb.com/search/title?title_type=feature,tv_movie&languages=en&num_votes=500,&production_status=released&release_date=%s,%s&sort=release_date,desc&count=20&start=1"
        ...
        for i in items:
            try:
                ...
                if (
                    ...
                    settingFanart == "true" and "fanart" in i and not i["fanart"] == "0"
                ):
                ...
                control.addItem(
                    handle=syshandle, url=url, listitem=item, isFolder=False
                )
            except:
                pass
