...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domain = 'filmsofts.com'
        self.base_link = 'http://filmsofts.com'
        ...
        self.search_options = '&search_start=0&full_search=1&result_from=1&titleonly=3&searchuser=&replyless=1' \
                              ...
                              '&catlist%5B%5D=2&catlist%5B%5D=4&catlist%5B%5D=23'
            ...
            for option in options:
                for query_base in query_bases:
                    ...
                    if html.status_code == 200:
                        posts = client.parseDOM(html.content, "div", attrs={"class": "main-news-link"})
                        for post in posts:
