...
class navigator:
    ...
    def root(self):
        ...
        self.addDirectoryItem('[B][COLOR gold]Overeasy Updates[/COLOR][/B]',  'ShowChangelog',  'icon.png',  'DefaultFolder.png')
        ...
        if self.getMenuEnabled('navi.channels') == True:
            ...
            self.addDirectoryItem(32631, 'boxsetsNavigator', 'boxsets.png', 'boxsets.png')
    ...
    def news(self):
            ...
            if len(message)>1:
                    if compfile == message:pass
                            ...
                            text_file.close()
                            compfile = message
            self.showText('[B][Overeasy User Agreement and Privacy Policy[/B][/I][/COLOR]', compfile)
