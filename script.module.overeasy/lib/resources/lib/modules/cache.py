...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Overeasy Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.overeasy')
    ...
    try:
        curVersion = control.addon('script.module.overeasy').getAddonInfo('version')
