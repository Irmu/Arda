...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'skynet Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.skynet')
    ...
    try:
        curVersion = control.addon('script.module.skynet').getAddonInfo('version')
