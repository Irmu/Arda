...
class navigator:
    ...
    NEWSFILE      = base64.b64decode(b'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3poVzhyVVhI')
    LOCALNEWS     = os.path.join(THISADDONPATH, 'skynet Updates.txt')
    
    def root(self):
        self.addDirectoryItem('[COLOR=white]Skynet Info[/COLOR]', 'newsNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def news(self):
            ...
            if len(message)>1:
                    if compfile == message:pass
                            ...
                            text_file.close()
                            compfile = message
            self.showText('[B][I][COLOR white]Skynet Latest Info[/COLOR][/B][/I]', compfile)
