...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://www1.watchseries.movie'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            result = client.request(url, headers={'User-Agent': client.agent()}, timeout=10)
            ...
            for url in urls:
                ...
                if 'vidcloud' in url:
                    ...
                    for url in match:
                        ...
                        url = requests.get(url, headers={'User-Agent': client.agent()}).url if 'vidnode' in url else url
