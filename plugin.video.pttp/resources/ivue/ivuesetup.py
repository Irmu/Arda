...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Enigma2Tv-Xtra/resources/ivue','Enigma2Tv-Xtra.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Enigma2Tv-Xtra/resources/ivue','plugin.video.Enigma2Tv-Xtra.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.Enigma2Tv-Xtra'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("Enigma2Tv-Xtra","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Enigma2Tv-Xtra/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Enigma2Tv-Xtra/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("Enigma2Tv-Xtra","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Enigma2Tv-Xtra","Installing iVue TV Guide...",'', 'Please Wait')
