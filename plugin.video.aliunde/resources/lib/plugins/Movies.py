"""
    ...
    -------- These are the xml examples you place in your xml to call the plugin
          Make the tag relevant to your plugin. <Movies> is the example below-----
    ...
    <Movies>genre/Action</Movies>
    </dir>

    <dir>
    <title>Template Comedy Movies</title>
    <Movies>genre/Comedy</Movies>
    </dir>    
...
----------------------------------------------------------
"""
table_id = "appfEtHnmMemq2KUv"
table_name = "Movies"
workspace_api_key = "keyAyjqpA8bMi0fzA"
"""
----------------------------------------------------------
"""
...
class Movies_Movie_List(Plugin):

    name = "Movies_movie_list"
