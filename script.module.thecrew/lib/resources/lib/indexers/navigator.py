...
#######################################################################
    ...
    def movies(self, lite=False):
        ...
        if self.getMenuEnabled('navi.247movies') == True:
            self.addDirectoryItem(90014, '247movies', '247_movies.png', 'DefaultMovies.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32044, 'openSettings&query=14.0', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32046, 'openSettings&query=17.0', 'tools.png', 'DefaultAddonProgram.png')
