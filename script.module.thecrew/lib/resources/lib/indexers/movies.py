...
class movies:
    def __init__(self):
        ...
        self.theaters_link = 'http://www.imdb.com/search/title?title_type=feature&num_votes=1000,&release_date=date[365],date[0]&sort=moviemeter,asc&count=40&start=1'
        ...
        self.onDeck_link = 'http://api.trakt.tv/sync/playback/movies?extended=full&limit=10'
...
#TC 2/01/19 started
    ...
    def languages(self):
        languages = [
            ...
            ('[COLOR dodgerblue][B]¤[/B][/COLOR] [B][COLOR white]Macedonian[/COLOR][/B] [COLOR dodgerblue][B]¤[/B][/COLOR]', 'mk'),
            ...
            ('[COLOR dodgerblue][B]¤[/B][/COLOR] [B][COLOR white]Slovenian[/COLOR][/B] [COLOR dodgerblue][B]¤[/B][/COLOR]', 'sl'),
        ...
        for i in languages: self.list.append({'name': str(i[0]), 'url': self.language_link % i[1], 'image': 'international.png', 'action': 'movies'})
        self.addDirectory(self.list)
        return self.list


    def certifications(self):
        certificates = ['[COLOR dodgerblue][B]¤[/B][/COLOR] [B][COLOR white]G[/COLOR][/B] [COLOR dodgerblue][B]¤[/B][/COLOR]', '[COLOR dodgerblue][B]¤[/B][/COLOR] [B][COLOR white]PG[/COLOR][/B] [COLOR dodgerblue][B]¤[/B][/COLOR]', '[COLOR dodgerblue][B]¤[/B][/COLOR] [B][COLOR white]PG-13[/COLOR][/B] [COLOR dodgerblue][B]¤[/B][/COLOR]', '[COLOR dodgerblue][B]¤[/B][/COLOR] [B][COLOR white]R[/COLOR][/B] [COLOR dodgerblue][B]¤[/B][/COLOR]', '[COLOR dodgerblue][B]¤[/B][/COLOR] [B][COLOR white]NC-17[/COLOR][/B] [COLOR dodgerblue][B]¤[/B][/COLOR]']
    ...
    def worker(self, level=1):
        ...
        self.fanart_tv_headers = {'api-key': 'MzliOTBhMDE3ZTM5MWFmZDMzNzUwZjk3ODI3ZjhkOTY='.decode('base64')}
