...
def _find_cache_version():
    ...
    try:
        ...
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/script.module.exoscrapers')
    ...
    try:
        ...
        oldVersion = '0'
    try:
        curVersion = control.addon('script.module.exoscrapers').getAddonInfo('version')
